...
petcat -text -w2 -o ascii_convert.pet ascii_convert.txt
petcat -text -w2 -o reader3.pet reader3.txt
petcat -text -w2 -o ml_loader.pet ml_loader.txt
c1541 -format test,t1 d64 test.d64
c1541 -attach test.d64 -write label.prg 
